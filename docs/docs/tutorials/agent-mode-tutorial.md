...
The `langgraph-agent` template sets `mode: agent` and points at `ghcr.io/agenttier/sandbox-langgraph:v0.8.1`, which preinstalls Python 3.11, LangGraph, LangChain, httpx, and the `mem0` client.
